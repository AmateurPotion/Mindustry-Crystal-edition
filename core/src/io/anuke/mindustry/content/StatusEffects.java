...
public class StatusEffects implements ContentList{
    public static StatusEffect none, potion, burning, freezing, wet, melting, tarred, overdrive, shielded, shocked, corroded, boss;
    ...
    public void load(){
        ...
        potion = new StatusEffect("Upgrade"){{
            effect = Fx.freezing;
            speedMultiplier = 0;
            damageMultiplier = 1000f;
            armorMultiplier = 0.00001f;
        }};
