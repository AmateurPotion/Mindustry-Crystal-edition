...
public class Blocks implements ContentList{
    ...
    //transport
    conveyor, titaniumConveyor, armoredConveyor, deflectorConveyor, distributor, junction, itemBridge, phaseConveyor, sorter, router, overflowGate, massDriver,
    ...
    public void load(){
        ...
        shockMine = new ShockMine("shock-mine"){{
            requirements(Category.defense, ItemStack.with(Items.lead, 25, Items.silicon, 12));
            hasShadow = false;
            health = 40;
            damage = 11;
            tileDamage = 7f;
 ...
 */
        ...
        cleaner = new LiquidTurret("Cleaner"){{
            requirements(Category.turret, () -> false, ItemStack.with(Items.graphite, 300, Items.lead, 75, Items.surgealloy, 100, Items.crystal, 3));
            ammo(
                    Liquids.water, Bullets.waterShot,
                    Liquids.slag, Bullets.slagShot,
                    Liquids.cryofluid, Bullets.cryoShot,
