...
public class Blocks implements ContentList{
    ...
    melter, separator, sporePress, pulverizer, incinerator, coalCentrifuge, crystalLab, siliconCompounder, phaseShifter, dimensionRepeater,
    ...
    //turrets
    duo, scatter, scorch, hail, arc, wave, lancer, swarmer, salvo, fuse, ripple, cyclone, spectre, meltdown, cleaner, nuclearLauncher,

    //units
    commandCenter, draugFactory, spiritFactory, phantomFactory, wraithFactory, ghoulFactory, revenantFactory, lichFactory, reaperFactory, daggerFactory, crawlerFactory, titanFactory,
    ...
    public void load(){
        ...
        orePolarstone = new OreBlock(Items.polarstone);
        ...
        phaseShifter = new GenericSmelter("phase-shifter"){{
            requirements(Category.crafting, ItemStack.with(Items.copper, 100, Items.lead, 100, Items.silicon, 50));
            craftEffect = Fx.smeltsmoke;
        ...
        dimensionRepeater = new GenericSmelter("dimension-repeater"){{
            requirements(Category.crafting, ItemStack.with(Items.copper, 100, Items.lead, 100));
            craftEffect = Fx.smeltsmoke;
            outputItem = new ItemStack(Items.prisium, 3);
            craftTime = 40f;
            size = 2;

            consumes.items(new ItemStack(Items.coal, 2), new ItemStack(Items.meteorShard, 1));
        }};
        ...
        crystalLab = new GenericCrafter("crystal-lab"){{
        	requirements(Category.crafting, ItemStack.with(Items.copper, 10000, Items.lead, 10000, Items.silicon, 1500, Items.metaglass, 3000, Items.graphite, 1000, Items.surgealloy, 500, Items.phasefabric, 100));
            outputItem = new ItemStack(Items.crystal, 1);
            craftTime = 1500f;
            size = 5;
            hasPower = true;
            hasLiquids = true;
            ...
            consumes.power(25f);
            consumes.items(new ItemStack(Items.metaglass, 100), new ItemStack(Items.silicon, 30), new ItemStack(Items.surgealloy, 10), new ItemStack(Items.phasefabric, 10), new ItemStack(Items.plastanium, 10), new ItemStack(Items.sporePod, 10));
        }};
        ...
        scrapWall = new Wall("scrap-wall"){{
            requirements(Category.defense, ItemStack.with(Items.scrap, 5));
            health = 60 * wallHealthMultiplier;
            variants = 5;
        }};

        scrapWallLarge = new Wall("scrap-wall-large"){{
            requirements(Category.defense, ItemStack.with(Items.scrap, 50));
        ...
        scrapWallHuge = new Wall("scrap-wall-huge"){{
            requirements(Category.defense, ItemStack.with(Items.scrap, 100));
        ...
        scrapWallGigantic = new Wall("scrap-wall-gigantic"){{
            requirements(Category.defense, ItemStack.with(Items.scrap, 250));
        ...
        polarbattery = new Battery("polar-battery"){{
            requirements(Category.power, ItemStack.with(Items.polarstone, 10));
            size = 2;
            consumes.powerBuffered(20000f);
        }};
        ...
        differentialGenerator = new SingleTypeGenerator("differential-generator"){{
            ...
            consumes.item(Items.polarstone).optional(true, false);
        ...
        crystalDrill = new Drill("crystal-drill"){{
            requirements(Category.production, ItemStack.with(Items.graphite, 100, Items.silicon, 100, Items.titanium, 50, Items.phasefabric, 10,Items.surgealloy, 100,Items.crystal, 1));
            drillTime = 1;
            size = 1;
            tier = 5;
            rotateSpeed = 10f;
            ...
            consumes.liquid(Liquids.water, 0f).boost();
        }};
        ...
        biotechnologyFacilities = new Fracker("biotechnology-Facilities"){{
            requirements(Category.liquid, ItemStack.with(Items.copper, 500, Items.graphite, 100, Items.lead, 200, Items.titanium, 100, Items.silicon, 50, Items.metaglass, 500 ,Items.crystal, 1));
            result = Liquids.potion;
            liquidCapacity = 50f;
            pumpAmount = 3f;
            size = 3;
            liquidCapacity = 30f;
            ...
            consumes.item(Items.sporePod, 5);
            consumes.power(2f);
            consumes.liquid(Liquids.water, 1.5f);
        }};

        energyInjector = new GenericCrafter("energy-injector"){{
            requirements(Category.power, ItemStack. with(Items.lead, 500, Items.graphite, 100, Items.silicon, 200, Items.plastanium, 100, Items.phasefabric, 25));
            hasItems = true;
            liquidCapacity = 60f;
            craftTime = 60f;
            outputItem = new ItemStack(Items.polarstone, 1);
            size = 3;
            health = 320;
            hasPower = hasLiquids = true;

            consumes.liquid(Liquids.slag, 0.25f);
            consumes.power(5f);
            consumes.item(Items.metaglass, 5);
 ...
 */
        ...
        ripple = new ArtilleryTurret("ripple"){{
            requirements(Category.turret, ItemStack.with(Items.copper, 150, Items.graphite, 135, Items.titanium, 60, Items.thorium, 60));
            ammo(
            Items.graphite, Bullets.artilleryDense,
            Items.silicon, Bullets.artilleryHoming,
            Items.pyratite, Bullets.artlleryIncendiary,
        ...
        cleaner = new LiquidTurret("Cleaner"){{
            requirements(Category.turret, BuildVisibility.debugOnly, ItemStack.with(Items.graphite, 300, Items.lead, 75, Items.surgealloy, 100, Items.crystal, 3));
            ammo(
                    Liquids.water, Bullets.waterShot,
                    Liquids.slag, Bullets.slagShot,
                    Liquids.cryofluid, Bullets.cryoShot,
                    Liquids.oil, Bullets.oilShot,
                    Liquids.potion, Bullets.potionShot
        ...
        nuclearLauncher = new Nuclearlauncher("nuclear-Launcher"){{
            requirements(Category.turret, ItemStack.with(Items.copper, 750, Items.graphite, 1000, Items.silicon, 100, Items.titanium, 300, Items.thorium, 2000, Items.polarstone, 100, Items.crystal, 3));
            ammo(
                    Items.crystal, Bullets.artilleryenerge
            );
            size = 3;
            targetAir = true;
            reload = 400f;
        ...
        lichFactory = new UnitFactory("lich-factory"){{
            requirements(Category.units, ItemStack.with(Items.copper, 10000, Items.lead, 10000, Items.graphite, 1000, Items.titanium, 200, Items.polarstone, 100));
            unitType = UnitTypes.lich;
            produceTime = 1000f;
            size = 8;
            maxSpawn = 2;
            health = 2000;
            ...
            consumes.power(5f);
            consumes.items(new ItemStack(Items.copper, 2000), new ItemStack(Items.lead, 2000), new ItemStack(Items.metaglass, 800), new ItemStack(Items.graphite, 500), new ItemStack(Items.coal, 200), new ItemStack(Items.titanium, 1000), new ItemStack(Items.silicon, 2000), new ItemStack(Items.polarstone, 100));
        }};

        reaperFactory = new UnitFactory("reaper-factory"){{
            requirements(Category.units, ItemStack.with(Items.copper, 20000, Items.lead, 20000, Items.graphite, 3000, Items.silicon, 1000, Items.scrap, 30000, Items.polarstone, 100));
            ...
            maxSpawn = 1;
            consumes.power(10f);
            consumes.items(new ItemStack(Items.copper, 5000), new ItemStack(Items.lead, 5000), new ItemStack(Items.graphite, 3000), new ItemStack(Items.surgealloy, 1000), new ItemStack(Items.crystal, 10));
        }};
        ...
        chaosArrayFactory = new UnitFactory("chaosArray-factory"){{
            requirements(Category.units, ItemStack.with(Items.lead, 5000, Items.graphite, 3000, Items.silicon, 1000 ,Items.titanium, 1000, Items.polarstone, 50));
            unitType = UnitTypes.chaosArray;
            produceTime = 750f;
            size = 5;
            maxSpawn = 2;
            itemCapacity = 1000;
            consumes.power(2.5f);
            consumes.items(new ItemStack(Items.graphite, 1000), new ItemStack(Items.titanium, 1000), new ItemStack(Items.silicon, 100), new ItemStack(Items.surgealloy, 100));
        }};

        eradicatorFactory = new UnitFactory("eradicator-factory"){{
            requirements(Category.units, ItemStack.with(Items.copper, 10000, Items.lead, 10000, Items.graphite, 750, Items.titanium, 1000, Items.thorium, 500, Items.polarstone, 100));
            ...
            itemCapacity = 2000;
            consumes.power(5f);
            consumes.items(new ItemStack(Items.graphite, 2000), new ItemStack(Items.titanium, 1000), new ItemStack(Items.silicon, 500), new ItemStack(Items.thorium, 300), new ItemStack(Items.crystal, 5));
        }};
...
/*
        phoenixPad = new MechPad("Phoenix-ship-pad"){{
            requirements(Category.upgrade, ItemStack.with(Items.lead, 1000, Items.silicon, 100, Items.titanium, 350, Items.plastanium, 300,Items.polarstone, 100, Items.surgealloy, 300,Items.crystal, 10));
            mech = Mechs.phoenix;
            size = 5;
            consumes.power(3f);
        }};

        cindustryPad = new MechPad("cindustry-mech-pad"){{
            requirements(Category.upgrade, ItemStack.with(Items.lead, 1000, Items.graphite, 300, Items.silicon, 1000, Items.thorium, 100,Items.scrap, 10000, Items.surgealloy, 300, Items.crystal, 10));
            mech = Mechs.cindustry;
            size = 5;
            consumes.power(3f);
        }};
*/
