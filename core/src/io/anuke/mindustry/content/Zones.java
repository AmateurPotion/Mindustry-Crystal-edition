...
public class Zones implements ContentList{
    ...
    saltFlats, fieldStrike, overgrowth, impact0078, crags,
    desolateRift, nuclearComplex, Arcticstation;
    ...
    public void load(){
        ...
        fieldStrike = new Zone("fieldStrike", new MapGenerator("fieldStrike")){{
            startingItems = ItemStack.list(Items.copper, 1000, Items.silicon, 1000, Items.lead, 1000, Items.scrap, 3000, Items.titanium, 1000, Items.graphite, 1500, Items.metaglass, 1000);
            loadout = Loadouts.basicNucleus;
            conditionWave = 5;
            launchPeriod = 5;
            zoneRequirements = ZoneRequirement.with(saltFlats, 20);
            blockRequirements = new Block[]{Blocks.daggerFactory, Blocks.draugFactory, Blocks.door, Blocks.waterExtractor};
            resources = new Item[]{Items.copper, Items.scrap, Items.lead, Items.coal, Items.sand, Items.titanium, Items.thorium};
        }};
        ...
        Arcticstation = new Zone("ArcticStation", new MapGenerator("ArcticStation", 1)){{
            startingItems = ItemStack.list(Items.scrap, 3000, Items.copper, 1000, Items.lead, 1000, Items.graphite, 300, Items.thorium, 500, Items.silicon, 1000);
            loadout = Loadouts.basicNucleus;
            conditionWave = 15;
            zoneRequirements = ZoneRequirement.with(craters, 30);
            blockRequirements = new Block[]{Blocks.polarbattery, Blocks.deflectorConveyor};
            resources = new Item[]{Items.copper, Items.lead, Items.coal, Items.sand, Items.scrap, Items.titanium, Items.thorium, Items.polarstone};
        }};
