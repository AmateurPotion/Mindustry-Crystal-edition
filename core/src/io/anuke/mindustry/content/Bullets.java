...
public class Bullets implements ContentList{
    ...
    //artillery
    artilleryDense, arilleryPlastic, artilleryPlasticFrag, artilleryHoming, artilleryIncendiary, artilleryExplosive, artilleryUnit, artilleryenerge,
    ...
    //liquid
    waterShot, cryoShot, slagShot, oilShot, potionShot,
    ...
    public void load(){
        ...
        artilleryenerge = new ArtilleryBulletType(1f, 0f, "shell"){{
            hitEffect = Fx.flakExplosion;
            knockback = 2f;
            lifetime = 50f;
            bulletWidth = bulletHeight = 50f;
            collidesTiles = false;
        ...
        potionShot = new LiquidBulletType(Liquids.potion){{
